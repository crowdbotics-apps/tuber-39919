"""
Django settings for tuber_39919 project.
...
WSGI_APPLICATION = 'tuber_39919.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tuber_39919 API",
    "DESCRIPTION": "API documentation for tuber_39919 App",
    "VERSION": "v1",
}
